...
import hashlib, bcrypt, subprocess,time
...
#Function that handles writing the produced hashes to unique text files for use within JtR
...
def run_john_attacks(hash_file, fmt, max_time):
    ...
    for mode, label in [("wordlist", "WL"), ("incremental", "I")]:
        print("Starting ",mode," Attack on",fmt)
    ...
    #Main execution chunk, starts timer as well as runs JtR through sub-process command
